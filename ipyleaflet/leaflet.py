...
class Icon(UILayer):
    ...
    icon_size = Tuple(None, allow_none=True).tag(sync=True, o=True)
    shadow_size = Tuple(None, allow_none=True).tag(sync=True, o=True)
    icon_anchor = Tuple(None, allow_none=True).tag(sync=True, o=True)
    shadow_anchor = Tuple(None, allow_none=True).tag(sync=True, o=True)
    popup_anchor = Tuple(None, allow_none=True).tag(sync=True, o=True)
